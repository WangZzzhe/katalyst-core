...
require (
	...
	github.com/kubewharf/katalyst-api v0.1.17-0.20230926151705-2bf76444f84a
...
replace (
	...
	github.com/kubewharf/katalyst-api => github.com/WangZzzhe/katalyst-api v0.0.0-20231013023342-74f0704afb10
	...
	k8s.io/controller-manager => k8s.io/controller-manager v0.17.9
	...
	k8s.io/node-api => k8s.io/node-api v0.17.9
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.17.9
	k8s.io/sample-controller => k8s.io/sample-controller v0.17.9
