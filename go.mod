...
require (
	...
	github.com/kubernetes-sigs/custom-metrics-apiserver v1.20.0
...
require (
	...
	k8s.io/cri-api v0.20.15 // indirect
...
replace (
	...
	github.com/kubewharf/katalyst-api => github.com/WangZzzhe/katalyst-api v0.0.0-20240507072946-ef9b4955ef3a
