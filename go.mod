...
replace (
	github.com/kubewharf/katalyst-api => github.com/WangZzzhe/katalyst-api v0.0.0-20231012111808-2db635b408c2
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.23.17
	...
	k8s.io/node-api => k8s.io/node-api v0.23.17
