...
func init() {
	// katalyst provider remove nodeResourceFit predicateKeys and LeastRequestedPriority, BalancedResourceAllocation priorityKeys
	// which are added to qosAwareNodeResources plugins for nonReclaimed pods.
...
func Run(ctx context.Context, cc *schedulerserverconfig.CompletedConfig, sched *scheduler.Scheduler) error {
	...
	klog.Infof("start leaderElection: %v", cc.LeaderElection)
...
func buildHandlerChain(handler http.Handler, authn authenticator.Request, authz authorizer.Authorizer) http.Handler {
	...
	failedHandler := genericapifilters.Unauthorized(scheme.Codecs, false)
