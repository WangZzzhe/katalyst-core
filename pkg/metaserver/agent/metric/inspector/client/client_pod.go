...
func (c *InspectorClient) GetPodContainerCPUStats(ctx context.Context, podUID string) (map[string][]types.Cell, error) {
	url := c.urls[types.ContainerCPUPath]

	return c.GetPodContainerStats(ctx, podUID, url)
}

func (c *InspectorClient) GetPodContainerCgroupMemStats(ctx context.Context, podUID string) (map[string][]types.Cell, error) {
	url := c.urls[types.ContainerCgroupMemoryPath]

	return c.GetPodContainerStats(ctx, podUID, url)
}

func (c *InspectorClient) GetPodContainerLoadStats(ctx context.Context, podUID string) (map[string][]types.Cell, error) {
	url := c.urls[types.ContainerLoadPath]

	return c.GetPodContainerStats(ctx, podUID, url)
}

func (c *InspectorClient) GetPodContainerCghardwareStats(ctx context.Context, podUID string) (map[string][]types.Cell, error) {
	url := c.urls[types.ContainerCghardwarePath]

	return c.GetPodContainerStats(ctx, podUID, url)
}

func (c *InspectorClient) GetPodContainerCgNumaStats(ctx context.Context, podUId string) (map[string]map[int][]types.Cell, error) {
...
func (c *InspectorClient) GetPodContainerStats(ctx context.Context, podUID string, url string) (map[string][]types.Cell, error) {
